...
<body>
  <pre>
    ...
    index.jsp가 번역된 index_jsp,class 파일로 요청이 매핑
    -> 클라이언트에세 index.jsp 코드가 그대로 출력됨
...
<%-- form 태그 method 기본 값은 GET --%>
  ...
  <h1>
    <a href="/el/scope">Servlet/JSP 범위별 내장 객체 + EL 사용법</a>
  </h1>
  ...
  <pre>
    - 클라이언트 요청을 받은 Servlet/JSP가
      직접 응답하는 것이 아닌
      다른 Servlet/JSP에
      HttpServletRequest, HttpServletletResponse
